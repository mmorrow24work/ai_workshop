...
- Offline hosting of LLM using Ollama and popular alternatives
- LLM tokens 
- Example packages for newbies such as Claude Pro - explain session limits and weekly limits 
- Harness options e.g. open-claw, hermes-agent, cursor
- Security best practices especially when working with client data
- AI ethics
- AI governance
- AI latest newbies
